...
# Start Backend (bind to 0.0.0.0 for network access)
echo -e "${CYAN}🐍 Starte Backend auf 0.0.0.0:8001...${NC}"
cd backend
source venv/bin/activate
...
echo -e "${CYAN}⚛️  Starte Frontend auf 0.0.0.0:3000...${NC}"
cd frontend
...
echo -e "${GREEN}╔═══════════════════════════════════════════════════════════╗${NC}"
echo -e "${GREEN}║                                                           ║${NC}"
echo -e "${GREEN}║     ✅ MultiBot Command Center gestartet!                 ║${NC}"
echo -e "${GREEN}║                                                           ║${NC}"
echo -e "${GREEN}╠═══════════════════════════════════════════════════════════╣${NC}"
echo -e "${GREEN}║                                                           ║${NC}"
...
echo -e "${GREEN}╚═══════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${YELLOW}💡 Andere Geräte im Netzwerk können über die IP zugreifen!${NC}"
echo ""
